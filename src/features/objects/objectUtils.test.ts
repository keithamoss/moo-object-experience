...
import { ObjectData, ParsedMetadataSchema } from '../../types/metadata';
  ...
  describe('getFieldsToDisplay', () => {
    ...
    it('should exclude title field', () => {
      const mockSchema = new ParsedMetadataSchema([
        { field: OBJECT_FIELDS.TITLE, label: 'Title', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Mandatory', purpose: 'Object title', fieldTypeAndControls: 'Free text', example: 'Example Title' },
        { field: OBJECT_FIELDS.DESCRIPTION, label: 'Description', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Mandatory', purpose: 'Object description', fieldTypeAndControls: 'Free text', example: 'Example Description' },
      ]);
      const object: ObjectData = {
    ...
    it('should exclude identifier field', () => {
      const mockSchema = new ParsedMetadataSchema([
        { field: OBJECT_FIELDS.IDENTIFIER, label: 'Identifier', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Mandatory', purpose: 'Object identifier', fieldTypeAndControls: 'Free text', example: '12345' },
        { field: 'dcterms:creator', label: 'Creator', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Creator name', fieldTypeAndControls: 'Free text', example: 'John Doe' },
      ]);
      const object: ObjectData = {
    ...
    it('should exclude fields with empty values', () => {
      const mockSchema = new ParsedMetadataSchema([
        { field: 'dcterms:creator', label: 'Creator', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Creator name', fieldTypeAndControls: 'Free text', example: 'John Doe' },
        { field: 'dcterms:date', label: 'Date', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Date', fieldTypeAndControls: 'ISO8601 compliant date', example: '2024-01-01' },
      ]);
      const object: ObjectData = {
        'dcterms:creator': 'Test Creator',
        'dcterms:date': '',
    ...
    it('should return all valid fields', () => {
      const mockSchema = new ParsedMetadataSchema([
        ...
        { field: 'dcterms:creator', label: 'Creator', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Creator name', fieldTypeAndControls: 'Free text', example: 'John Doe' },
        { field: 'dcterms:date', label: 'Date', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Date', fieldTypeAndControls: 'ISO8601 compliant date', example: '2024-01-01' },
        { field: 'dcterms:subject', label: 'Subject', namespace: 'Dublin Core', applicableCollections: 'All', required: 'Optional', purpose: 'Subject', fieldTypeAndControls: 'Free text', example: 'Art' },
      ]);
      const object: ObjectData = {
        [OBJECT_FIELDS.TITLE]: 'Test Title',
        'dcterms:creator': 'Test Creator',
